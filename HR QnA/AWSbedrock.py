...
if __name__ == "__main__":
    ...
    print(agents)
    # agent_id = "GXLYSVDBSQ",
    # agent_alias_id = "BJ6TFUTWS8",

    response, traces = bedrock_client.invoke_bedrock_agent(agent_id="ZZLAFHVMUO",
                                                           agent_alias_id="BZZGM4CJIW",
                                                           session_id="session_1",
                                                           #    prompt="What are my core working hours?"
                                                           #    prompt="What are my lunch timings?"
                                                           prompt="Tell me about future leaders program?"
                                                           )
